...
**Health** is the widest module. It syncs Oura ring data over OAuth (sleep, readiness, HRV, resting heart rate), logs food by photo or text or barcode with AI calorie estimation, and tracks water, caffeine, body weight and supplements with supply counts. An AI coach reads the whole picture and writes commentary on it.
